...
const Footer = () => {
  return (
    <footer className="p-sectionPadding h-screen bg-secondary text-white rounded-t-3xl">
      <div className='grid grid-cols-12 items-end'>
        <div className='col-span-9'>
          <h1 className='xl:text-8xl font-[melodrama] uppercase w-3/4'>Unleash your inner glow with every visit.</h1>
        </div>
        <div className='col-span-3 flex justify-end items-start flex-col gap-8'>
          ...
          <button className='bg-primary text-[nunito] text-secondary font-bold w-full uppercase py-4 flex justify-center items-center text-xl'>Book your appointment <MdArrowOutward /></button>
        </div>
      </div>
      <div className='mt-24 grid grid-cols-12 border-b-2'>
